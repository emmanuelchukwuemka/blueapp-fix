    ...
    return (
        <NavigationContainer>
            <Stack.Navigator screenOptions={{ headerShown: false }}>
                ...
                <Stack.Screen name="SupportTicket" component={SupportTicketScreen} options={{ headerShown: false }} />
                <Stack.Screen name="Debug" component={DebugScreen} options={{ headerShown: true, title: 'API Debug' }} />
            </Stack.Navigator>
        </NavigationContainer>
    );
}
