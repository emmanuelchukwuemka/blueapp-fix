...
import { View, StyleSheet, ScrollView, TouchableOpacity, Image, Dimensions, Animated, KeyboardAvoidingView, Platform, Alert } from 'react-native';
...
export default function RegisterScreen({ navigation }) {
    ...
    const handleRegister = async () => {
        ...
        try {
            const userData = {
                full_name: accountType === 'partner' ? companyName : name,
                email,
                password,
            };
