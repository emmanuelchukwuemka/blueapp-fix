...
import { View, StyleSheet, ScrollView, TouchableOpacity, ImageBackground, Animated, Alert } from 'react-native';
                    ...
                    <Animated.View style={[styles.headerContent, { opacity: fadeHeader }]}>
                        <View>
                            ...
                            <Text variant="headlineMedium" style={styles.nameText}>
                                {(user.full_name || user.name) ? (user.full_name || user.name).split(' ')[0] : 'User'}!
                            </Text>
                        </View>
                        <View style={styles.headerActions}>
                            ...
                            <TouchableOpacity onPress={() => navigation.navigate('Profile')} style={styles.profileButton}>
                                {user.profileImage ? (
                                    ...
                                    <Avatar.Text size={40} label={(user.full_name || user.name) ? (user.full_name || user.name).substring(0, 2).toUpperCase() : 'BP'} style={{ backgroundColor: Colors.secondary }} />
                                )}
                            </TouchableOpacity>
                        </View>
                    </Animated.View>
